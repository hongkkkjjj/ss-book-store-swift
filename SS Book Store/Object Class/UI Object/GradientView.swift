...
public class Gradient: UIView {
    @IBInspectable var startColor:   UIColor = ColorUtil.lightBlue { didSet { updateColors() }}
    @IBInspectable var endColor:     UIColor = ColorUtil.lightGreen { didSet { updateColors() }}
